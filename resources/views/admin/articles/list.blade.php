...
@section('content')
	<div class="row">
		<div class="col-md-12">
				...
				<tbody>
					@foreach($articles as $article)
						...
						>
							...
							<td>
								@if(Auth::user()->hasPermission('articles_edit'))
									<a class="btn btn-primary hidden-xs" href="{{ route('admin.articles.edit', $article) }}">Edit</a>
								@endif
			...
			<p class="text-right"><a class="btn btn-primary" href="{{ route('admin.articles.create') }}">Post News</a></p>
		</div>
	</div>
@stop