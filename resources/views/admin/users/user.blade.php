...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="{{action('Admin\UserController@postUser', [$user->id])}}" method="post">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-11">
                        <input id="active" class="form-control" type="checkbox" name="active" value="1" {{$user->active ? 'checked' : ''}}>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            ...
            <p>
                <button id="save-permissions" class="btn btn-primary"
                        data-url="{{ action('Admin\UserController@postUpdatePermissions', [$user->id]) }}">
                    Save Permissions
                </button>
            </p>
        </div>
